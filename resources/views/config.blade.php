...
@section('content')
	<h1 class="text-4xl">{{__('Laravel Setup Configuration')}}</h1>
	<p class="mb-2 italic">{{__('Package info')}}</p>
	<div class="table w-full">
		@forelse(config('eutranet-setup.models') as $model)
			<div class="flex flex-row align-top align-text-top mb-4 border-b-2 justify-between">
				<div class="lg:table-cell">
					...
					@if(class_exists('Eutranet\\Setup\\Models\\'.$model))
						@php $class = 'Eutranet\\Setup\\Models\\'.$model @endphp
